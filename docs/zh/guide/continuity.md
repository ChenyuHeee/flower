...
### `continuous=True` 改变了 `resume_from` 的语义 {#continuoustrue-改变了-resume_from-的语义}
...
### 唤醒时说的那句话,要落到三个地方 {#唤醒时说的那句话要落到三个地方}
...
### 崩在第一步(确认需求)之内也能接上 {#崩在第一步确认需求之内也能接上}
...
### 韧性:断网时挂着等,而且错误不进接续后的上下文 {#韧性断网时挂着等而且错误不进接续后的上下文}
...
### 代价:上下文会一直涨,而且没有尽头 {#代价上下文会一直涨而且没有尽头}
