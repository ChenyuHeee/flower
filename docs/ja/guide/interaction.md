...
### `handoff` の三つの phase {#handoff-的三个-phase}
...
### 人に聞く:`Ask` と `HumanChannel` {#问人ask-与-humanchannel}
...
### oracle:run を邪魔せずに一言聞く {#旁路顾问问一句而不打扰运行}
