...
### Un cran d'arrêt contre l'emballement {#一道防跑飞的闸}
...
### Le handoff n'est pas un retry : comment la comptabilité est tenue {#换代不算重试账怎么记}
